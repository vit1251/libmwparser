...
acute: ACUTE closedTerm {
  $$ = itex2MML_copy3("<mover>", $2, "<mo stretchy=\"false\">&acute;</mo></mover>");
  itex2MML_free_string($2);
}
| WIDEACUTE closedTerm {
  $$ = itex2MML_copy3("<mover>", $2, "<mo>&acute;</mo></mover>");
  itex2MML_free_string($2);
};

grave: GRAVE closedTerm {
  $$ = itex2MML_copy3("<mover>", $2, "<mo stretchy=\"false\">&grave;</mo></mover>");
  itex2MML_free_string($2);
}
| WIDEGRAVE closedTerm {
  $$ = itex2MML_copy3("<mover>", $2, "<mo>&grave;</mo></mover>");
  itex2MML_free_string($2);
};

breve: BREVE closedTerm {
  $$ = itex2MML_copy3("<mover>", $2, "<mo stretchy=\"false\">&breve;</mo></mover>");
  itex2MML_free_string($2);
}
| WIDEBREVE closedTerm {
  $$ = itex2MML_copy3("<mover>", $2, "<mo>&breve;</mo></mover>");
  itex2MML_free_string($2);
};
